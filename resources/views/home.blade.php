...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <img src="https://pbs.twimg.com/profile_images/1288073614655467523/OQWj_FjO_400x400.jpg" style="min-height: 75px ;height: 20vw; max-height: 150px; margin-top: -75px; border: 5px solid white;" class="ml-3 rounded-circle profile-picture" alt="Profile Picture">
        </div>
    </div>
